...
import com.speed.provider.ui.fragments.Help;
import com.speed.provider.ui.fragments.SummaryFragment;
import com.speed.provider.helper.SharedHelper;
import com.speed.provider.helper.URLHelper;
import com.speed.provider.listeners.Connect;
import com.speed.provider.utills.CustomTypefaceSpan;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void loadNavHeader() {
        ...
        if (SharedHelper.getKey(MainActivity.this, "rating") != null
                && !SharedHelper.getKey(MainActivity.this, "rating").equals("")) {
            tvRate.setText(SharedHelper.getKey(MainActivity.this, "rating") + "");
        }
    }
