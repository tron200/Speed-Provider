...
import com.speed.provider.ui.activities.login.ForgotPassword;
import com.speed.provider.ui.activities.login.SignUp;
...
//                                        login(loginResult.getAccessToken().getToken(), URLHelper.FACEBOOK_LOGIN, "facebook");
            ...
            builder.setNegativeButton(getString(R.string.cancel_), new DialogInterface.OnClickListener() {
                @Override
